...
describe ActivitiesController do
  ...
  #describe "PUT update" do
    #describe "with valid params" do
      #it "updates the requested activity, if the activity belongs to current user" do
        #activity = Activity.create! valid_attributes
        ...
        #Activity.any_instance.should_receive(:update_attributes).with({ "status" => "My Status Update" })
        #put :update, {:id => activity.to_param, :activity => { "status" => "My Status Update" }}, valid_session
      #end
    ...
    #describe "with invalid params" do
      #it "assigns the activity as @activity" do
        ...
        #Activity.any_instance.stub(:save).and_return(false)
        #put :update, {:id => activity.to_param, :activity => { "status" => "invalid value" }}, valid_session
        #assigns(:activity).should eq(activity)
      #end
